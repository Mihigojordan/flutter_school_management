// lib/features/Dashboard/record/mood/great_mood_form.dart
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import '../../../../services/mood_service.dart';

class GreatMoodForm extends StatefulWidget {
  const GreatMoodForm({Key? key}) : super(key: key);

  @override
  State<GreatMoodForm> createState() => _GreatMoodFormState();
}

class _GreatMoodFormState extends State<GreatMoodForm> {
  ...
  void initState() {
    super.initState();
    _titleController.text = 'Great - ${DateFormat('MMM dd, yyyy - HH:mm').format(DateTime.now())}';
  }
