// lib/features/Dashboard/record/mood/sad_mood_form.dart
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import '../../../../services/mood_service.dart';

class SadMoodForm extends StatefulWidget {
  const SadMoodForm({Key? key}) : super(key: key);

  @override
  State<SadMoodForm> createState() => _SadMoodFormState();
}

class _SadMoodFormState extends State<SadMoodForm> {
  ...
  void initState() {
    super.initState();
    _titleController.text = 'Sad - ${DateFormat('MMM dd, yyyy - HH:mm').format(DateTime.now())}';
  }
