// lib/features/Dashboard/record/mood/miserable_mood_form.dart
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import '../../../../services/mood_service.dart';

class MiserableMoodForm extends StatefulWidget {
  const MiserableMoodForm({Key? key}) : super(key: key);

  @override
  State<MiserableMoodForm> createState() => _MiserableMoodFormState();
}

class _MiserableMoodFormState extends State<MiserableMoodForm> {
  final _formKey = GlobalKey<FormState>();
  final _titleController = TextEditingController();
  final _descriptionController = TextEditingController();
  final MoodService _moodService = MoodService();
  
  String _selectedEmotion = 'Sad';
  ...
  void initState() {
    super.initState();
    _titleController.text = 'Miserable - ${DateFormat('MMM dd, yyyy - HH:mm').format(DateTime.now())}';
  }
